import{_ as n,c as a,o as l,P as p}from"./chunks/framework.NCDsjgYA.js";const o="/my-docs/DataStructure/DoublyLinkedList.png",C=JSON.parse('{"title":"DoublyLinkedList 双链表结构","description":"","frontmatter":{},"headers":[],"relativePath":"zh/DataStructure/DoublyLinkedList.md","filePath":"zh/DataStructure/DoublyLinkedList.md","lastUpdated":1753061327000}'),e={name:"zh/DataStructure/DoublyLinkedList.md"};function t(c,s,r,E,y,i){return l(),a("div",null,s[0]||(s[0]=[p('<h1 id="doublylinkedlist-双链表结构" tabindex="-1">DoublyLinkedList 双链表结构 <a class="header-anchor" href="#doublylinkedlist-双链表结构" aria-label="Permalink to &quot;DoublyLinkedList 双链表结构&quot;">​</a></h1><p>  双链表(DoublyLinkedList)是也一种<strong>链式存储</strong>的数据结构。每个结点的构成：<strong>元素</strong>(数据元素的映象) + <strong>前驱指针</strong>(指示前驱元素存储位置) + <strong>后继指针</strong>(指示后继元素存储位置) <img src="'+o+`"></p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p><strong>特点：线性结构，链式存储</strong></p><p> 核心思想 =&gt; 通过改变节点的 <strong>next 指向</strong> 和 <strong>prev 指向</strong> 实现插入、删除的操作</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">class</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">DoublyNode</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div>`,3)]))}const h=n(e,[["render",t]]);export{C as __pageData,h as default};
